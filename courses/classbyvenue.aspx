<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeBehind="classbyvenue.aspx.cs" Inherits="ProductivityPointGlobal.courses.ClassByVenue" %>
            ...
            <div class="pageLColumnContent">
                <div class="pageLHeaderBoxCourseDetail">
                    <div class="secondaryHeaderBG">
                        <div style="float: left; padding: 10px 0 10px 10px; width: 170px;"><h2 class="Grey">Class</h2></div>
                        <div style="float: left; padding: 10px 0 10px 10px; width: 170px;"><h2 class="Grey">Date</h2></div>
                        <div style="float: left; padding: 10px 0 10px 10px; width: 180px;"><h2 class="Grey">Time</h2></div>
                    ...
                    <asp:Repeater ID="ctlClassSchedule" runat="server">
                        <ItemTemplate>
                            <div class="courseColumnContainer">
                                ...
                                <div style="float: left; padding: 18px 0 10px 10px; width: 170px;"><p class="Grey"><%# Eval("courseName") %></p></div>
                                <div style="float: left; padding: 18px 0 10px 10px; width: 170px;"><p class="Grey"><asp:Label ID="Label1" Text='<%#DateTime.Parse(Eval("startDate").ToString()).ToString("MM/dd/yyyy") %>' runat="server" /> - <asp:Label ID="ctlEndDate" Text='<%#DateTime.Parse(Eval("endDate").ToString()).ToString("MM/dd/yyyy") %>' runat="server" /></p></div>
                                <div style="float: left; padding: 18px 0 10px 10px; width: 180px;"><p class="Grey"><asp:Label ID="ctlLabel3" Text='<%#DateTime.Parse(Eval("startTime").ToString()).ToString("h:mm t.\\M.") %>' runat="server" /> - <asp:Label ID="ctlEndTime" Text='<%#DateTime.Parse(Eval("endTime").ToString()).ToString("h:mm t.\\M.") %>' runat="server" /> <%# Eval("timeZone") %></p></div>
