<%@ Page  Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeBehind="coursetopicmainpage.aspx.cs" Inherits="ProductivityPointGlobal.courses.coursetopicmainpage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <%try
        {
            if (CourseType != null && TopicName != null)
            {%>
                <%#
                    CourseType != null && TopicName !=null ?
                    string.Format("<link rel=\"canonical\" href=\"{0}://{1}/topic/{2}/{3}\" />", Request.Url.Scheme, Request.Url.Host,TopicName.ToLower().Replace(" ","-"),CourseType.ToLower().Replace(" ","-"))
                    :""%>
                <%}
        }catch(Exception ex) { } %>
    <style>
    ...
    <div id="HeadingDiv" class="container-fluid city-view subPage" runat="server">
        <div class="row">
            <p class="breadcrumb-box">
                ...
                <a style="font-size:11px"  class="breadcrumb-active-link"> <%=TopicName %> </a>
            </p>
            <div class="container">
                    ...
                    <div class="col-lg-8 col-md-7 col-sm-6 col-xs-12">  
                        <div class="section1RowSubpage">
                             <h1 class="white fontShadow">
                                 <span class="brandMain"> <%=TopicName %></span>  <br />
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                        <div>
                              <h2 style="font-size:25px;padding-top:20px;font-family: HelveticaNeueLTStd;" class="city-mainpage-heading text-center subSectionPadding">
                                    <%=TopicName %> Training Overview
                              </h2>
                        </div>

                        <p  class="">
                            <%=CheckEmptyData(CourseTopicDescription) %>
                        </p>
                        <div>
