<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeBehind="locationsfilteredByEvent.aspx.cs" Inherits="ProductivityPointGlobal.LocationsfilteredByEvent" %>
                    ...
                    <asp:Repeater ID="masterRepeater" runat="server">
                        <ItemTemplate>
                            <div class="stateLocationContainer">                                
                                <div style="margin: 0px 0px 0px 10px;"><asp:LinkButton ID="ctlState" Text='<%# Eval("state") %>' PostBackUrl='<%# Eval("state", "State/{0}") %>' CssClass="DarkBlue" runat="server" /></div>
                            </div>                           
                        </ItemTemplate>
                    </asp:Repeater>                
                </div>                                  
