<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeBehind="desktop-applications.aspx.cs" Inherits="ProductivityPointGlobal.DesktopApplications" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
        <%#string.Format("<link rel=\"canonical\" href=\"{0}://{1}/desktop-applications.aspx\" />", Request.Url.Scheme, Request.Url.Host) %>
<style>
   ...
   <div class="container-fluid city-view subPage">
        <div class="row" style="margin-top:44px;">
             <p class="breadcrumb-box hidden-xs">
                ...
                <a style="font-size:11px"  class="breadcrumb-active-link">Desktop Applications</a>
            </p>
            <div class="container">
                        ...
                        <div class="section1RowSubpageCityPage" style="height:175px">
                            <p>
                                <h1 class="white fontShadow mobile-padding-heading-top">
                                    <span class="catalog-main-page-heading" style="margin-top:0px;line-height:1.4">Computer Skills & </span><br />
                                    <span class="catalog-main-page-sub-heading" style="margin-top:0px;line-height:1.4">Software Training Classes</span>
                                </h1>                             
                            </p> 
                        </div>
                    </div>
         ...
         <div class="row">
             <div class="container">
                 <div class="row">
                     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div>
                              <h2 style="font-size:25px;padding-top:20px;line-height:1.4;padding-bottom: 10px;margin-top:0px;" class="city-mainpage-heading text-center subSectionPadding">
                                    Build your end-user knowledge and expertise with <br /> Productivity Point certified and industry-leading training courses
                              </h2>
                        </div>
                         <div class="row left-padding-topics right-padding-topics"  >
                             <div class="col-md-12">
                                 <p style="font-size:18px;">
                                     Productivity Point Learning Solutions provides authorized 
                                      training and certification programs designed to grow your 
                                      computer skills and validate your ability to leverage the 
                                      opportunities you set your sights on. Choose a traditional
                                      live classroom, live online training setting or one of the 
                                      Official On-Demand options, to learn on your own schedule, 
                        ...
                        <%-- <div style="text-align:center;margin-top:40px;">
                             <p style="padding-top:20px;padding-bottom: 10px;" class="city-mainpage-heading training-delivery-heading text-center subSectionPadding">
                                 Technology Brands
                             </p>
                         </div>
                         <div class="row" style="padding-left:100px;margin-top:18px;">
                             <asp:Repeater ID="CatalogBrandRepeater" runat="server">
                                 <ItemTemplate>
                        
                                     <div  class="col-md-4 col-sm-5 col-xs-11 catalog-link-style">
                                         <a href="/brand/<%#Eval("catalogBrand").ToString().Replace(" ","-").ToLower() %>/desktop-applications"><%#Eval("catalogBrand") %></a>
                                     </div>
                                 </ItemTemplate>
                             ...
                             <div class="col-md-4">
                                 <%for (int i = 0; i < firstRowTopic; i++){
                                    ...
                                    <div class="col-md-12 catalog-link-style">
                                      <a href="/topic/<%=catalogTopics.ToString().Replace(" ","-").ToLower() %>/desktop-applications"><%=catalogTopics %></a>
                                 </div>
                                 <%} %>
                ...
                <div id="exTab3"  >	
                    ...
                    <div style="text-align:center">
                        ...
                        <li class="active" style="margin-left:0px;">
                            <a class="hidden-sm hidden-xs"  href="#1b" data-toggle="tab">
                                <img alt="After-Class Instructor Support" class="tab-image" src="/images/courses_site_images/team.png" />
			            ...
			            <li>
                            <a class="hidden-sm hidden-xs" href="#2b" data-toggle="tab">
                                 <img alt="Personalized Account Management" class="tab-image"  src="/images/courses_site_images/Customer_Service.PNG.png" />
			            ...
			            <li>
                            <a class="hidden-sm hidden-xs" href="#3b" data-toggle="tab">
                                <img class="tab-image" alt="Class Recordings"  src="/images/courses_site_images/video_camera_icon.png" />
                          ...
                          <a class="hidden-sm hidden-xs" href="#4b" data-toggle="tab">
                              <img class="tab-image" alt="Satisfaction Guarantee" src="/images/courses_site_images/thumb_up_gesture_icon.png" />
                 ...
                 <div style="margin-left:60px;margin-top:20px;" class="tab-content clearfix">
			            <div class="tab-pane active" id="1b">
                            <div class="row">
                                <div class="col-md-1">
                                    <img alt="Team" class="tab-image-inside" src="/images/courses_site_images/team.png" />
                                </div>
				        ...
				        <div class="tab-pane" id="2b">
                             <div class="row">
                                <div class="col-md-1">
                                    <img class="tab-image-inside"  alt="Personalized Account Management" src="/images/courses_site_images/Customer_Service.PNG.png" />
                                </div>
                                <div class="col-md-11 tab-inner-div">
                        ...
                        <div class="tab-pane" id="3b">
                             <div class="row">
                                <div class="col-md-1">
                                     <img class="tab-image-inside" alt="Class Recordings"  src="/images/courses_site_images/video_camera_icon.png" />
                                </div>
                                <div  class="col-md-11 tab-inner-div">
                        ...
                        <div class="tab-pane" id="4b">
                             <div class="row">
                                    <div class="col-md-1">
                                        <img class="tab-image-inside" alt="Satisfaction Guarantee" src="/images/courses_site_images/thumb_up_gesture_icon.png" />
                                    </div>
                                    <div class="col-md-11 tab-inner-div">
                        ...
                        <div style="text-align:center">
                            ...
                            <li class="active" style="margin-left:0px;">
                                <a class="hidden-sm hidden-xs" href="#11b" data-toggle="tab">
                                    <img alt="Classroom Live" class="tab-image" src="/images/cities_site_images/Classroom_Icon.png" />
			                ...
			                <li>
                                <a class="hidden-sm hidden-xs" href="#12b" data-toggle="tab">
                                    <img alt="Classroom Virtual" class="tab-image"  src="/images/cities_site_images/Remote_Icon.png" />
			                ...
			                <li>
                                <a class="hidden-sm hidden-xs" href="#13b" data-toggle="tab">
                                     <img alt="Live Online" style="padding-top:12px;" class="tab-image" src="/images/cities_site_images/Live_Online.png" />
                              ...
                              <a class="hidden-sm hidden-xs" href="#14b" data-toggle="tab">
                                  <img alt="Private Group" class="tab-image" style="margin-top:6px;" src="/images/cities_site_images/Private_Groups_New.png" />
                              ...
                              <a class="hidden-sm hidden-xs" href="#15b" data-toggle="tab">
                                   <img alt="On Demand" class="tab-image" src="/images/cities_site_images/On_Demand.png" />
                                    ...
                                    <div class="col-md-12">
                                        <div class="row" >
                                            <div class="col-md-1 delivery-methods-image">
                                                <img class="tab-image" alt="Classroom Live Training" src="/images/cities_site_images/Classroom_Icon.png" />
                                            </div>
				            ...
				            <div class="tab-pane" id="12b">
                                 <div class="row delivery-method-box" id="classsroom-virtual-training">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-1 delivery-methods-image">
                                                <img class="tab-image" alt="Classroom Virtual Training" src="/images/cities_site_images/Remote_Icon.png" />
                                            </div>
                                            <div style="padding-left:40px;" class="col-md-11 delivery-methods-header">
                            ...
                            <div class="tab-pane" id="13b">
                                 <div class="row delivery-method-box" id="live-online-training">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-1 delivery-methods-image">
                                                <img style="margin-left:20px;" alt="Live Online Training" class="tab-image"  src="/images/cities_site_images/Live_Online.png" />
                                            </div>
                                            <div style="padding-left:40px;" class="col-md-11 delivery-methods-header">
                            ...
                            <div class="tab-pane" id="14b">
                                 <div class="row delivery-method-box" id="private-group-training">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-1 delivery-methods-image">
                                                <img style="margin-left:20px;" alt="Private Group Training" class="tab-image" src="/images/cities_site_images/Private_Groups_New.png" />
                                            </div>
                                            <div style="padding-left:40px;" class="col-md-11 delivery-methods-header">
                             ...
                             <div class="tab-pane" id="15b">
                                 <div class="row delivery-method-box" id="on-demand-learning">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-1 delivery-methods-image">
                                                <img alt="On-Demand Learning" class="tab-image" src="/images/cities_site_images/On_Demand.png" />
                                            </div>
