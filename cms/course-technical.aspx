<%@ Page Title="" Language="C#" MasterPageFile="~/cms/admin.master" AutoEventWireup="true" CodeBehind="course-technical.aspx.cs" Inherits="ProductivityPointGlobal.cms.CourseTechnical" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-md-12">
            <h3>Add a Technical Course Link</h3>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
    ...
    <div class="row">
        <div class="col-md-12">
            <h3>Edit Technical Course Links</h3>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
                ...
                <Columns>
                    <asp:TemplateField HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden" FooterStyle-CssClass="hidden">
                        <HeaderTemplate>
                            <thead>
                            <tr class="active">
                                <th class="col-sm-4">Tools</th>
                                <th class="col-sm-8">Cat 2</th>                                
                            </tr>
                            </thead>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <td>
                                <div class="btn-group" role="group" aria-label="...">
                                    <asp:Button Text="Edit" style="margin:5px" CssClass="btn btn-warning" CommandName="Edit" runat="server"/>&nbsp;
                                    <asp:Button Text="Delete" style="margin:5px" CssClass="btn btn-danger" CommandName="Delete" OnClientClick='<%# Eval("cat2", "return confirm(\"Delete item [{0}]?\");") %>' runat="server"/>&nbsp;
                                    <a style="margin:5px" href="/cms/CourseManage.aspx?id=<%# Eval("id") %>" class="btn btn-success"> Manage </a>
                                </div>
                            </td>                            
