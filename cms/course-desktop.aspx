<%@ Page Title="" Language="C#" MasterPageFile="~/cms/admin.master" AutoEventWireup="true" CodeBehind="course-desktop.aspx.cs" Inherits="ProductivityPointGlobal.cms.CourseDesktop" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-md-12">
            <h3>Add a Desktop Application Link</h3>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
    ...
    <div class="row">
        <div class="col-md-12">
            <h3>Edit Desktop Application Links</h3>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
