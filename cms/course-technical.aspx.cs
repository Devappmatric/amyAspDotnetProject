...
{
    public partial class CourseTechnical : System.Web.UI.Page
    {
        ...
        {
            ctlAdminCMS.DataSource = CmsAdmin.GetMainCourseLinks("TechnicalCourses");
        ...
        {            
            ...
            CmsAdmin.AddHomePageLink(cat2Value, "TechnicalCourses");
            cat2.Text = "";
