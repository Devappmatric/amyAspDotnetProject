...
{
    public partial class CourseDesktop : Page
    {
        ...
        {
            ctlAdminCMS.DataSource = CmsAdmin.GetMainCourseLinks("DesktopApplications");
        ...
        protected void ctlInsertRecord_Click(object sender, EventArgs e)
        {
            ...
            CmsAdmin.AddHomePageLink(cat2Value, "DesktopApplications");
            cat2.Text = "";
