...
{
    public partial class Confirmation2 : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var paymentNumber = Request.QueryString["ordernumber"];
            ...
            if (!IsPostBack)
            {
                ...
                ctlPaymentStatus.Text = paymentMethod == "Check" ? "Pending" : "Paid";
                ctlPO.Text = paymentNumber;
