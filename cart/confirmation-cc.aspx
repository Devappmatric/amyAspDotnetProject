<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeBehind="confirmation-cc.aspx.cs" Inherits="ProductivityPointGlobal.Cart.Confirmation" EnableEventValidation="false" %>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <ItemTemplate>
                                ...
                                <tr>
                                    <td colspan="4">
                                        ...
                                        <br />
                                        <strong>Location:</strong><br />
                                        <asp:Literal ID="ltrLocation" runat="server" Text='<%#string.Format("{0} {1}", Eval("address1"),Eval("address2")) %>'></asp:Literal>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-md-9 col-sm-10 col-xs-8 text-right sectionSubHeadingPrices">
                                <strong>Total:</strong>
