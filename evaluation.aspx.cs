...
namespace ProductivityPointGlobal
{
    public partial class Evaluation : Page
    {
        ...
        protected void ctlSubmit_OnClick(object sender, EventArgs e)
        {
            ...
            mailMessage.Append("<strong>9. Would you recommend this course to other people in your company?</strong> " + ddlQ8.SelectedValue + "<br /><br />");
            ...
            mailMessage.Append("<strong>12. What other courses would you like to have available in the future?</strong><br />");
            mailMessage.Append(tbQ11.Text + "<br /><br />");
            mailMessage.Append("<strong>13. Do you have friends or associates who may also benefit from our Services? If so, please list them here:</strong><br />");
            mailMessage.Append("Name: " + txtFriend1.Text + " Phone/E-mail: " + txtFriendPhone1.Text + "<br />");
            mailMessage.Append("<strong>14. I would like more information on your services:</strong><br />");
            mailMessage.Append("My Name: " + tbMoreInfo.Text + "<br />Please call or e-mail me at: " + tbMoreInfoPhone.Text + "<br /><br />");
