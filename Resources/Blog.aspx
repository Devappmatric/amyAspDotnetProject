<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/default.Master" CodeBehind="Blog.aspx.cs" Inherits="ProductivityPointGlobal.Resources.Blog" %>



<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <%#string.Format("<link rel=\"canonical\" href=\"{0}://{1}/Resources/Blog.aspx />", Request.Url.Scheme, Request.Url.Host) %>
