<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeBehind="technical-courses.aspx.cs" Inherits="ProductivityPointGlobal.TechnicalCourses" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
        <%#string.Format("<link rel=\"canonical\" href=\"{0}://{1}/technical-courses.aspx\" />", Request.Url.Scheme, Request.Url.Host) %>
<style>
   ...
   <div class="container-fluid city-view subPage" >
        <div class="row" style="margin-top:44px;">
             <p  class="breadcrumb-box hidden-xs">
                ...
                <a style="font-size:11px"  class="breadcrumb-active-link">Technical Courses</a>
            </p>
            <div class="container">
                        ...
                        <div class="section1RowSubpageCityPage" style="height:175px">
                            <p>
                                <h1  class="white fontShadow mobile-padding-heading-top">
                                    <span class="catalog-main-page-heading" style="margin-top:0px;line-height:1.4">Certified Technical Training</span><br />
                                    <span class="catalog-main-page-sub-heading"  style="margin-top:0px;line-height:1.4">Course Catalog</span>
                                </h1>                             
                            </p> 
                        </div>
                    </div>
     ...
     <div class="container-fluid bgWhite padding75B">
                     ...
                     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div>
                              <h2 style="font-size:25px;padding-top:20px;line-height:1.4;padding-bottom: 10px;margin-top:0px;" class="city-mainpage-heading text-center subSectionPadding">
                                    Build your technical knowledge and expertise with <br /> Productivity Point certified and industry-leading training courses
                              </h2>
                        </div>
                         <div class="row left-padding-topics right-padding-topics"  >
                             <div class="col-md-12">
                                 <p style="font-size:18px;">
                                     Productivity Point Learning Solutions provides authorized IT training and certification programs 
                                 designed to grow your skills and validate your ability to leverage the opportunities you set your 
                                 sights on. Attend hands-on technical training in a traditional live classroom, live online training 
                                 setting or one of our Official On-Demand options, to learn on your own schedule, at your own pace, 
                         ...
                         <div style="text-align:center;margin-top:40px;">
                             <h3 style="padding-top:20px;padding-bottom: 10px;" class="city-mainpage-heading training-delivery-heading text-center subSectionPadding">
                                 Technology Brands
                             </h3>
                         </div>
                         <div class="row  left-padding-topics" style="margin-top:18px;">
                             <%
                                 var brandCount = Brands.Rows.Count;
                                 var firstRow =(int) Math.Ceiling(((decimal)brandCount / 3));
                                 var secondRow =2*firstRow;
                                 %>
                             <div class="col-md-4">
                                 <%for (int i = 0; i < firstRow; i++){
                                         var dataRow=Brands.Rows[i];
                                         var catalogTopics = dataRow["catalogBrand"].ToString();
                                         %>
                                    <div class="col-md-12 catalog-link-style">
                                      <a href="/brand/<%=catalogTopics.ToString().Replace(" ","-").ToLower() %>/technical-courses"><%=catalogTopics %></a>
                                 </div>
                                 <%} %>
                             ...
                             <div class="col-md-4">
                                <%for (int i = secondRow; i < brandCount; i++){
                                         var dataRow=Brands.Rows[i];
                                         var catalogTopics = dataRow["catalogBrand"].ToString();
                                         %>
                                    <div class="col-md-12 catalog-link-style">
                         ...
                         <div class="row left-padding-topics" style="margin-top:18px;">
                             ...
                             <div class="col-md-4">
                                 <%for (int i = 0; i < firstRowTopic; i++){
                                         ...
                                         %>
                                    <div class="col-md-12 catalog-link-style">
                                      <a href="/topic/<%=catalogTopics.ToString().Replace(" ","-").ToLower() %>/technical-courses"><%=catalogTopics %></a>
                                 </div>
                                 <%} %>
         ...
         <div class="row" style="margin-top:40px;margin-bottom:30px;">
             <div class="col-md-12">
                ...
                <div id="exTab3"  >	
                     <h3 style="text-align:center;margin-bottom:22px;" class="training-delivery-heading">
          ...
          <div class="row">
            <div class="col-md-12">
                <div class="training-delivery-method-box">
                    <h3 style="text-align:center" class="training-delivery-heading">
